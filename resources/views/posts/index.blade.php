      ...
      <div class="-my-8 divide-y-2 divide-gray-100">
        <div class="py-8 flex flex-wrap md:flex-nowrap">
            ...
            <span class="flex gap-[10px] mt-4">
              <a href="/posts/{post}" class="hover:bg-gray-300 p-2 rounded-md block">
                <svg class='w-5 h-5 cursor-pointer' fill="#000000" version="1.1" id="Capa_1"
                  ...
                  height="800px" viewBox="0 0 494.936 494.936" xml:space="preserve">
                  <g>
                    <g>
              ...
              <a href="/posts/{post}" class="hover:bg-gray-300 p-2 rounded-md block">
                <svg class='w-5 h-5 cursor-pointer' width="800px" height="800px" viewBox="0 0 24 24" fill="none"
          ...
          <div class="md:flex-grow">
            ...
            <a href='/posts/{post}' class="text-indigo-500 inline-flex items-center mt-4">Learn More
